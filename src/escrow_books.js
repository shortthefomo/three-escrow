		...
		Object.assign(this, {
            ...
            listenOffers() {
                ...
                const worker = async (currency, issuer) => {
                    const query =`SELECT escrow.sequence, escrow.escrow_condition, escrow.account, escrow.amount, escrow.rate, cancel_after, escrow.collateral FROM escrow 
                    ...
                    for (let index = 0; index < rows.length; index++) {
                        ...
                        if (PubSubManager != null) {
                            ...
                            if (PubSubManager.checkChannel(json.message.account)) {
